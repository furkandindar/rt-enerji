...
// Next.js 16: useParams gibi dinamik route hook'ları kendi Suspense boundary'sinde olmalı.
export default function MyRequestDetailPage() {
  return (
    <Suspense fallback={<Loading />}>
      <MyRequestDetailPageInner />
    </Suspense>
  );
}

function MyRequestDetailPageInner() {
  ...
  // İptal sonrası talep CANCELLED'a düşer; 404 olmaz, sayfa güncel state'i gösterir.
  const refresh = () => {
    loadRequest();
  };
