...
CREATE TABLE IF NOT EXISTS "public"."employees" (
    ...
    CONSTRAINT "employees_signature_font_check" CHECK (((("signature_font")::"text" = ANY (ARRAY[('Ballet'::character varying)::"text", ('Great Vibes'::character varying)::"text", ('Sacramento'::character varying)::"text"])) OR ("signature_font" IS NULL)))
);
