...
import { CalendarPlus, FileCheck, ClipboardList, Banknote, Calculator, Clock, UserPlus, UserMinus, FileText, Stamp, MapPin, FilePenLine, type LucideIcon } from "lucide-react";
